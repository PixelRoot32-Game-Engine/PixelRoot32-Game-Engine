/**
 * @file test_bomberbot_phase2_bombing.cpp
 * @brief Unit tests for Bomberbot Phase 2 — bomb/explosion sprite rendering.
 *
 ...
 * header-only BomberbotBombs module. Also covers Phase 2+ range-aware
