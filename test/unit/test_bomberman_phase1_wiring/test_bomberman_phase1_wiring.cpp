/**
 * @file test_bomberman_phase1_wiring.cpp
 * @brief Unit tests for Bomberman Phase 1 sprite wiring.
 *
...
#include "BombermanBoard.h"     // TileType
...
// Test 4
void test_bomberman_palette_is_16_entries_with_transparent_index_zero(void) {
    TEST_ASSERT_EQUAL(16, (int)(sizeof(BOMBERMAN_SPRITE_PALETTE_RGB565) / sizeof(uint16_t)));
...
int main(int argc, char **argv) {
    ...
    RUN_TEST(test_bomberman_palette_is_16_entries_with_transparent_index_zero);
    return UNITY_END();
}
