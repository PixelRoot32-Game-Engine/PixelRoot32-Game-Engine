 ...
 */
    ...
    /// Cell<->world grid for the tic-tac-toe board (design.md D8). The origin
    /// centres the board on the display and is compile-time derivable, so
    /// kBoardGrid is constexpr like kSnakeGrid.
