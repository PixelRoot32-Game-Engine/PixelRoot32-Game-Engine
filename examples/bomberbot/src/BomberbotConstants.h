...
/**
 * @file BomberbotConstants.h
 * @brief Bomberbot game configuration: geometry, fixed-step timing, entity
 *        ceiling.
 */
 ...
 * BomberbotScene::update() — every rule function downstream of that
 ...
 * than that gives the chain-reaction queue in BomberbotBombs.cpp a bound
 ...
 * stage as the bomb fuses (BomberbotScene::logicStep()); reaching zero
