...
#define ARP_DEMO_CELL()                                                                                               \
    pr32::audio::makeNote(DEMO_ARP_VOICE, pr32::audio::Note::E, 3, ARP_STEP),                       \
        pr32::audio::makeNote(DEMO_ARP_VOICE, pr32::audio::Note::G, 3, ARP_STEP),                   \
        pr32::audio::makeNote(DEMO_ARP_VOICE, pr32::audio::Note::B, 3, ARP_STEP),                   \
        pr32::audio::makeNote(DEMO_ARP_VOICE, pr32::audio::Note::E, 4, ARP_STEP)
...
static const pr32::audio::MusicNote sArpDemoLeadNotes[] = {
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::E, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::B, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::E, 6, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::D, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::C, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::B, 4, Q),
    pr32::audio::makeRest(Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 4, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::Fs, 4, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 4, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::A, 4, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::B, 4, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::C, 5, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::B, 4, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::E, 5, H),
    pr32::audio::makeRest(W),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::E, 5, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::B, 4, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 4, E),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::E, 5, Q),
    pr32::audio::makeRest(Q),
    pr32::audio::makeRest(W),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::E, 5, H),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 5, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::B, 5, Q),
    pr32::audio::makeNote(DEMO_MELODY_LEAD, pr32::audio::Note::G, 5, E),
    pr32::audio::makeRest(Q),
};
...
static const pr32::audio::MusicNote sArpDemoDrumsNotes[] = {
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, Q),
    ...
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, E),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
    ...
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, S),
    pr32::audio::makeNote(DEMO_DRUM_SNARE, pr32::audio::Note::Rest, 1, S),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, Q),
    pr32::audio::makeNote(DEMO_DRUM_HIHAT, pr32::audio::Note::Rest, 1, E),
