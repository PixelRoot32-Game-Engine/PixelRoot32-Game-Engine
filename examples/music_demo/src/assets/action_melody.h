...
static const pr32::audio::MusicNote sActionHarmonyNotes[] = {
    ...
    pr32::audio::makeNote(DEMO_HARMONY, pr32::audio::Note::G, 5, Q),
    pr32::audio::makeRest(Q),
    pr32::audio::makeRest(Q),
    pr32::audio::makeNote(DEMO_HARMONY, pr32::audio::Note::D, 5, Q),
    pr32::audio::makeNote(DEMO_HARMONY, pr32::audio::Note::Fs, 5, Q),
    pr32::audio::makeRest(Q),
    pr32::audio::makeRest(W),
    pr32::audio::makeRest(Q),
    pr32::audio::makeNote(DEMO_HARMONY, pr32::audio::Note::G, 5, Q),
...
static const pr32::audio::MusicNote sActionDrumsNotes[] = {
    pr32::audio::makeNote(DEMO_DRUM_KICK, pr32::audio::Note::Rest, 1, E),
