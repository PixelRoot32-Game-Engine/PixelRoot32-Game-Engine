...
- **4 pre-composed melodies** — multi-voice tracks; **Melody 1** uses a **SAW** lead and **Melody 2** a **SINE** lead (see [`src/assets/melodies.h`](src/assets/melodies.h))
- **Melody 4 + ARP voice** — short E-minor lead loop plus a **`secondVoice`** track of fast **`MusicNote`** steps (`WaveType::SINE`)
