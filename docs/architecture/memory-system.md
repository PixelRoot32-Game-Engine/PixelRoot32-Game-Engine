...
| `RoomGraph<2>` (typical example) | ~100 B (2 × 40 B + 12 B) | ~120 B (2 × 48 B + 16 B) | The `room_screen` example ships with N=2 |
...
| A 2-room layer (`room_screen`) | 40 B flash, 0 B SRAM | 48 B flash, 0 B SRAM | 2 × 16 B rooms + the layer header |
